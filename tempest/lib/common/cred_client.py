...
class V2CredsClient(CredsClient):
    ...
    def create_user(self, username, password, project, email):
            params = {'name': username,
                      ...
                      'email': email}
            return super(V2CredsClient, self).create_user(**params)
...
class V3CredsClient(CredsClient):
    ...
    def create_user(self, username, password, project, email, domain=None):
        if domain is None:
            domain = self.creds_domain
        params = {'name': username,
                  'password': password,
                  ...
                  'email': email,
                  'domain_id': domain['id']}
        return super(V3CredsClient, self).create_user(**params)
